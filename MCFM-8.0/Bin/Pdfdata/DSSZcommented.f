...
*
*
* WARNING: GLUON PDF and nPDF become negative for very low Q^2 and small x.
*          This is inherited from reference MSTW PDFs. The rate can then 
*          be ill-defined for Q^2~1.5 GeV^2.  
*
*
 ...
 10   continue
     ...
     1     /2.d0   
      ...
      GA=DSSZFINT(NARGA,XTA,NAA,ARRFA,XGFA)* (1.d0-x)**5.d0*x**(-0.1d0)
       ...
       if (q.lt.1.4d0) then
c       write(6,*) 'warning: below charm threshold, c(x,Q^2)=0'
       ca=0.d0
       c=0.d0
       endif

       if (q.lt.4.75d0) then
c       write(6,*) 'warning: below bottom threshold, b(x,Q^2)=0'
       ba=0.d0
       b=0.d0
       endif
